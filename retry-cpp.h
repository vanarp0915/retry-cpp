...
struct retry_parameter {
    ...
    int stop_after_attempt_count = 3;
    long stop_after_delay_count = 3;
    float wait_before_retry = 3;
    float exponential_delay_factor = 2;
};
        ...
        try {
            ...
            if (retry_value.wait_before_retry > 0) {
                ...
                if (retry_value.exponential_delay) {
                    ...
                    std::cout << "expoenntial factor:  " <<time <<std::endl;
                }
